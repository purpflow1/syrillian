...
syrillian::inventory::submit! { FixedJoint::DATA }
syrillian::inventory::submit! { RevoluteJoint::DATA }
syrillian::inventory::submit! { PrismaticJoint::DATA }
syrillian::inventory::submit! { SphericalJoint::DATA }
syrillian::inventory::submit! { RopeJoint::DATA }
syrillian::inventory::submit! { SpringJoint::DATA }
